...
public class UserDetails implements org.springframework.security.core.userdetails.UserDetails {
    ...
    public UserDetails(@NotNull Long id, @NotNull String login, @NotNull String username, @NotNull String password, @NotNull List<RoleEntity> roles, boolean isLocked) {
        setId(id);
        setLogin(login);
